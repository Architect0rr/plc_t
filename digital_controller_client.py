...
class gui(plc_tools.plc_socket_communication.tools_for_socket_communication):
    def __init__(self,args,log):
        ...
        self.log = log
        self.setpoint = {'A': 8*[None], 'B': 8*[None], 'dispenser': {'n': None, 'ton': None, 'shake': False, 'port': None, 'channel': None, 'toff': None}, 'C': 8*[None], 'D': 8*[None]}
        ...
        self.dispenser['n entry'] = tkinter.Entry(self.frame3,justify=tkinter.CENTER,textvariable=self.dispenser['n val'],width=3)
        ...
        self.dispenser['ton entry'] = tkinter.Entry(self.frame3,justify=tkinter.CENTER,textvariable=self.dispenser['ton val'],width=4)
        ...
        self.dispenser['toff entry'] = tkinter.Entry(self.frame3,justify=tkinter.CENTER,textvariable=self.dispenser['toff val'],width=4)
        ...
        self.dispenser['port entry'] = tkinter.Entry(self.frame3,justify=tkinter.CENTER,textvariable=self.dispenser['port val'],width=2)
        ...
        self.dispenser['channel entry'] = tkinter.Entry(self.frame3,justify=tkinter.CENTER,textvariable=self.dispenser['channel val'],width=2)
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="Author: Daniel Mohr\nDate: %s\nLicense: GNU GENERAL PUBLIC LICENSE, Version 3, 29 June 2007\n\n%s" % (__digital_controller_client_date__,help),
