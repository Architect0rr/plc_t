...
class translation_stage():
    ...
    def __init__(self,config=None,pw=None,debugprint=None,controller=None):
        ...
        self.start_controller_button = tkinter.Button(self.init_frame,text="open RS232 (tsc)",command=self.controller['tsc'].start_request,padx=self.padx,pady=self.pady)
        self.start_controller_button.pack()
        self.stop_controller_button = tkinter.Button(self.init_frame,text="close RS232 (tsc)",command=self.controller['tsc'].stop_request,padx=self.padx,pady=self.pady)
        ...
        self.x["10000 down button"] = tkinter.Button(f,command=self.x["10000 down cmd"],text="x-10000",padx=self.padx,pady=self.pady)
        self.x["10000 down button"].grid(column=0,row=0)
        self.x["1000 down button"] = tkinter.Button(f,command=self.x["1000 down cmd"],text="x-1000",padx=self.padx,pady=self.pady)
        ...
        self.x["n up/down entry"] = tkinter.Entry(self.x["n up/down frame"],textvariable=self.x["n up/down val"],width=6)
        self.x["n up/down entry"].grid(column=0,row=0)
        self.x["n up/down button"] = tkinter.Button(self.x["n up/down frame"],command=self.x["n up/down cmd"],text="do",padx=self.padx,pady=self.pady)
        self.x["n up/down button"].grid(column=1,row=0)
        self.x["1000 up button"] = tkinter.Button(f,command=self.x["1000 up cmd"],text="x+1000",padx=self.padx,pady=self.pady)
        self.x["1000 up button"].grid(column=3,row=0)
        self.x["10000 up button"] = tkinter.Button(f,command=self.x["10000 up cmd"],text="x+10000",padx=self.padx,pady=self.pady)
        ...
        self.y["10000 down button"] = tkinter.Button(f,command=self.y["10000 down cmd"],text="y-10000",padx=self.padx,pady=self.pady)
        self.y["10000 down button"].grid(column=0,row=0)
        self.y["1000 down button"] = tkinter.Button(f,command=self.y["1000 down cmd"],text="y-1000",padx=self.padx,pady=self.pady)
        ...
        self.y["n up/down entry"] = tkinter.Entry(self.y["n up/down frame"],textvariable=self.y["n up/down val"],width=6)
        self.y["n up/down entry"].grid(column=0,row=0)
        self.y["n up/down button"] = tkinter.Button(self.y["n up/down frame"],command=self.y["n up/down cmd"],text="do",padx=self.padx,pady=self.pady)
        self.y["n up/down button"].grid(column=1,row=0)
        self.y["1000 up button"] = tkinter.Button(f,command=self.y["1000 up cmd"],text="y+1000",padx=self.padx,pady=self.pady)
        self.y["1000 up button"].grid(column=3,row=0)
        self.y["10000 up button"] = tkinter.Button(f,command=self.y["10000 up cmd"],text="y+10000",padx=self.padx,pady=self.pady)
        ...
        self.z["10000 down button"] = tkinter.Button(f,command=self.z["10000 down cmd"],text="z-10000",padx=self.padx,pady=self.pady)
        self.z["10000 down button"].grid(column=0,row=0)
        self.z["1000 down button"] = tkinter.Button(f,command=self.z["1000 down cmd"],text="z-1000",padx=self.padx,pady=self.pady)
        ...
        self.z["n up/down entry"] = tkinter.Entry(self.z["n up/down frame"],textvariable=self.z["n up/down val"],width=6)
        self.z["n up/down entry"].grid(column=0,row=0)
        self.z["n up/down button"] = tkinter.Button(self.z["n up/down frame"],command=self.z["n up/down cmd"],text="do",padx=self.padx,pady=self.pady)
        self.z["n up/down button"].grid(column=1,row=0)
        self.z["1000 up button"] = tkinter.Button(f,command=self.z["1000 up cmd"],text="z+1000",padx=self.padx,pady=self.pady)
        self.z["1000 up button"].grid(column=3,row=0)
        self.z["10000 up button"] = tkinter.Button(f,command=self.z["10000 up cmd"],text="z+10000",padx=self.padx,pady=self.pady)
    ...
    def power(self):
        if self.power_status.get()==0:
            ...
            s = True
        self.debugprint("switch translation stage to %s" % b2onoff(s))
        self.controller[self.config.values.get('translation stage controller','power_controller')].setpoint[self.config.values.get('translation stage controller','power_port')][int(self.config.values.get('translation stage controller','power_channel'))] = s
