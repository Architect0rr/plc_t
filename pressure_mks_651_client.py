...
def main():
    ...
    parser.add_argument("-ip", nargs=1, default="localhost", type=str, required=False, dest="ip", help="Set the IP/host n. default: localhost", metavar="n")
    parser.add_argument("-port", nargs=1, default=15122, type=int, required=False, dest="port", help="Set the port p. default: 15122", metavar="p")
    parser.add_argument(
