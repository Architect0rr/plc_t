...
class multi_purpose_controller(plcclientserverclass.socket_communication_class):
    ...
    def myinit(self):
        ...
        self.actualvalue = {'DO': 4*[None],
                            ...
                            'DAC': 4*[0.0],
                            'DI' : 4*[None],
                            'ADC' : 8*[0]} # dict of values on device
        self.setpoint = {'DO': 4*[None],
                         'R': 2*[None],
                         'U05': None,
                         'U15': None,
                         'U24': None,
                         'DAC': 4*[0.0]} # dict of requested values, which will be updated to device
        self.ports = ['DO','R','U05','U15','U24','DAC','DI','ADC']
        self.ports_without_channel = ['U05','U15','U24']
        self.setpoint_port = ['DO','R','U05','U15','U24','DAC']
        self.actualvalue_port = ['DO','R','U05','U15','U24','DAC','DI','ADC']
